...
allHrs.Array.forEach(eml => elm.style.border = "1px solid tomato");
// Change the background of all the hr to "antiquewhite" using for of loop.
allHrs.Array.forEach(eml => elm.style.backgroundColor = "antiquewhite");
// Change the 'border-radius' of all the hr to "5px" using array.
allHrs.Array.forEach(eml => elm.style.borderRadius = "5px");
...
let para2 = ocument.createElement('p');
